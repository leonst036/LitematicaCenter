...
dependencies {
    ...
    // Litematica and MaLiLib dependencies via CurseMaven
    modImplementation("curse.maven:malilib-303119:5647783")
    modImplementation("curse.maven:litematica-308892:5647809")
